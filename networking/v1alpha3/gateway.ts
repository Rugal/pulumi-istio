...
export class Gateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1alpha3:Gateway';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.networking.v1alpha3.GatewaySpec>;
...
export interface GatewayArgs {
     ...
     * Configuration affecting edge load balancer. See more details at: https://istio.io/docs/reference/config/networking/gateway.html
     */
    readonly spec?: pulumi.Input<inputs.networking.v1alpha3.GatewaySpecArgs>;
