...
export class ServiceEntry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1alpha3:ServiceEntry';
    ...
    public readonly kind!: pulumi.Output<"ServiceEntry">;
     ...
     */
    public readonly spec!: pulumi.Output<outputs.networking.v1alpha3.ServiceEntrySpec>;
...
export interface ServiceEntryArgs {
     ...
     * Configuration affecting service registry. See more details at: https://istio.io/docs/reference/config/networking/service-entry.html
     */
    readonly spec?: pulumi.Input<inputs.networking.v1alpha3.ServiceEntrySpecArgs>;
