...
export class Sidecar extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:networking.istio.io/v1alpha3:Sidecar';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.networking.v1alpha3.SidecarSpec>;
...
export interface SidecarArgs {
     ...
     * Configuration affecting network reachability of a sidecar. See more details at: https://istio.io/docs/reference/config/networking/sidecar.html
     */
    readonly spec?: pulumi.Input<inputs.networking.v1alpha3.SidecarSpecArgs>;
